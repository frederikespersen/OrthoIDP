...
if dir is None:
    dir = fasta_path.split('/')[-1].split('.')[0]
dir = f'results/{dir}'
...
# Starting simulation with sequence
simulate(sequence=sequence, boxlength=boxlength, dir=dir, steps=steps, eqsteps=1000, cond=cond, platform=platform)
