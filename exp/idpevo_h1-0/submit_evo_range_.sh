...
#SBATCH -o results/range_.out
#SBATCH -e results/range_.err

# Getting job input options
input_seqs=(H1-0_AVG_MIN_KAPPA H1-0_AVG_MIN_KAPPA H1-0_AVG_MIN_KAPPA H1-0_AVG_MIN_KAPPA H1-0_AVG_MIN_KAPPA H1-0_AVG_MIN_KAPPA H1-0_AVG_MAX_KAPPA H1-0_AVG_MAX_KAPPA H1-0_AVG_MAX_KAPPA H1-0_AVG_MAX_KAPPA H1-0_AVG_MAX_KAPPA)
